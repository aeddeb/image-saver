...
def save_image(form_image):
    ...
    image_path = os.path.join(app.root_path, 'user_images', image_fn)
...
def upload_to_s3(image_name):
    ...
    parser = ConfigParser()
    config_file = os.path.join(app.root_path, 'aws_creds.conf')
    ...
    local_file = os.path.join(app.root_path, 'user_images', image_name)
    s3_file = image_name
